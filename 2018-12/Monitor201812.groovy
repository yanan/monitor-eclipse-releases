File version201809 = new File("2018-12.txt") 

String Versions201809 = version201809.text

def mat = Versions201809 =~/a href=\"\/downloads\/packages\/release\/2018-12\/.*?\">(.*?)Packages<\/a><\/li>/ 
...
File expectFile = new File("Expected201812.txt")
