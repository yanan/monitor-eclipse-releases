File version202003 = new File("2020-03.txt") 

String Versions202003 = version202003.text

def mat = Versions202003 =~/a href=\"\/downloads\/packages\/release\/2020-03\/.*?\">(.*?)Packages<\/a><\/li>/ 
...
File expectFile = new File("Expected202003.txt")
